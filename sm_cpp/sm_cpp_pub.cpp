...
int main() {
    iox::runtime::PoshRuntime::initRuntime("sm_cpp_pub");

    iox::capro::ServiceDescription temperature_service("sensor_data", "sm_cpp_pub", "temperature");
    iox::capro::ServiceDescription humidity_service("sensor_data", "sm_cpp_pub", "humidity");
    iox::capro::ServiceDescription current_service("sensor_data", "sm_cpp_pub", "current");
    ...
    */
    ...
    std::cout << "[sm_cpp_pub] sm_cpp_pub is ready" << std::endl;
...
void send_data(float temperature, int humidity, float current) {
    try {
        ...
        http::request<http::string_body> req(http::verb::post, "/node/sm_cpp_1/data", 11);
